...
// Función para redirigir al registro de productos
const dirRegistro = () => {
...
let productosFiltrados = productos; // Array que almacena los productos filtrados
...
const vaciarFiltros = () => {
  document.getElementById("nombre").value = ""; // Restablece el valor del filtro 1
  document.getElementById("precio").value = ""; // Restablece el valor del filtro 2
  document.getElementById("categoria").value = ""; // Restablece el valor del filtro 3
};

const vaciarTabla = () => {
  document
    .getElementById("tablita")
    .getElementsByTagName("tbody")[0].innerHTML = ""; // Borra los resultados de la tabla
